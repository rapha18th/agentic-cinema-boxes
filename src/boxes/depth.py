...
SCOUT = Depth("scout", objectives=5, queries_per_objective=1, extract_urls=2,
              full_content=False, images_per_round=4, max_rounds=2,
              confidence_target=0.80, emergent_gaps_per_round=1)

PRODUCTION = Depth("production", objectives=10, queries_per_objective=2, extract_urls=4,
                   full_content=True, images_per_round=10, max_rounds=3,
                   confidence_target=0.82, emergent_gaps_per_round=2)

KUBRICK = Depth("kubrick", objectives=16, queries_per_objective=3, extract_urls=6,
                full_content=True, images_per_round=20, max_rounds=6,
                confidence_target=0.90, emergent_gaps_per_round=3)
